...
video_path = Path("E:\\automatic-number-plate-recognition\\anpr_video.mp4")  #input video path
...
frame = cv2.VideoCapture("E:\\automatic-number-plate-recognition\\anpr_video.mp4")
